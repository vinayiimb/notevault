...
export default function CGPACalculator() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {subjects.map((sub, i) => (
          <motion.div
            ...
            className="bg-surface rounded-xl border p-4 grid grid-cols-[1fr_80px_80px_40px] gap-3 items-center shadow-sm"
          >
            <input
              value={sub.name}
      ...
      {/* Result */}
      <div className="bg-surface rounded-xl border p-5 space-y-4 shadow-sm">
