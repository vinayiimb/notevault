...
import { RequestNotesModal } from "@/components/notes/request-notes-modal";
...
export function StudyAccessShowcase() {
  ...
  function handleMobileSubmit(e: React.FormEvent) {
    ...
    if (selectedCourse) {
      ...
      router.push(`/papers?view=reader&q=${encodeURIComponent(q)}`);
    } else {
      router.push("/papers?view=reader");
    }
  }
  ...
  return (
    <>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted leading-tight">Select your degree or open Interactive PDF</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <span>Open in Interactive PDF Viewer →</span>
              </button>

              <button
                type="button"
                onClick={() => setIsRequestModalOpen(true)}
                className="flex w-full items-center justify-center gap-2 rounded-2xl border border-pink-400/30 bg-pink-500/10 py-2.5 text-xs font-bold text-pink-600 dark:text-pink-400 transition hover:bg-pink-500/20"
              >
                <span>🎀 Request Free Subject Notes</span>
              </button>
            </div>
          </form>
        </div>
          ...
          <div className="study-access-cards">
            ...
            <article className="study-access-card study-access-card--glass">
              <h2 className="study-access-card__title">
                <span aria-hidden="true">📚</span> ALL PYQ
              </h2>
              ...
              <Link href="/papers?view=reader" className="study-access-card__small-button">
                Open All PYQs →
              </Link>
            </article>
            ...
            <article className="study-access-card study-access-card--glass">
              ...
              <button
                type="button"
                onClick={() => setIsRequestModalOpen(true)}
                className="study-access-card__small-button cursor-pointer"
              >
                Request Free Notes →
              </button>
            </article>
      ...
      {/* Demand / Request Free Notes Modal */}
      <RequestNotesModal
